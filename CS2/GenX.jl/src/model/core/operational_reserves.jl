...
@doc raw"""
	operational_reserves!(EP, inputs::Dict, setup::Dict)
...
"""
function operational_reserves!(EP, inputs::Dict, setup::Dict)
...
@doc raw"""
	operational_reserves_contingency!(EP, inputs::Dict, setup::Dict)
...
"""
function operational_reserves_contingency!(EP, inputs::Dict, setup::Dict)
...
@doc raw"""
	operational_reserves_core!(EP, inputs::Dict, setup::Dict)
...
"""
function operational_reserves_core!(EP, inputs::Dict, setup::Dict)
