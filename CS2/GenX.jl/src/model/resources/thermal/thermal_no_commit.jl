@doc raw"""
	thermal_no_commit!(EP, inputs::Dict, setup::Dict)
...
"""
function thermal_no_commit!(EP, inputs::Dict, setup::Dict)
...
@doc raw"""
	thermal_no_commit_operational_reserves!(EP, inputs::Dict)
...
"""
function thermal_no_commit_operational_reserves!(EP, inputs::Dict)
