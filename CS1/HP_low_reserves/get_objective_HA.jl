...
# Build Dummy graph with slacks (used for matching variables to saved solutions)
...
monolith_obj_HA = get_objective_HA_level(graph, "/results/32d_monolith/mipgap_results", "_day", ".csv", 1, 32, offset = 9)
serial_obj_HA   = get_objective_HA_level(graph_slacks, "/results/32d_serial/HAED_results", "_day", ".csv", 1, 32)

println("Objective of serial is ", serial_obj_HA)
println("Objective of monolith is ", monolith_obj_HA)
